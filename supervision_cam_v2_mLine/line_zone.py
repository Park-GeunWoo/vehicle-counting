...
def check_line_crossing_multiple_zones(
    ...
    for line_zone in line_zones:
        ...
        if line_zone.is_crossing(prev_coords, curr_coords):
            ...
            direction_vector = line_zone.end - line_zone.start
            curr_direction = np.cross(direction_vector, curr_coords - line_zone.start)
            prev_direction = np.cross(direction_vector, prev_coords - line_zone.start)
